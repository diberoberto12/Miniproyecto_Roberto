...
<html lang="en">
  ...
  <body> 
           ...
           <div class="table table-resonsive">
             <table class="table table-hover table-bordered">
              ...
              <tr>
                 ...
                 <th><a href="<?php echo base_url('/index.php/obtenerInformacion').'/'.$dato->id ?>" class="btn btn-sm btn-warning">Editar</a></h>
    ...
    <script src="https://unpkg.com/sweetalert/dist/sweetablert.min.js"></inscript>
    <script>
